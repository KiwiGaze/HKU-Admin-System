...
const Student = sequelize.define('Student', {
    ...
    belongsTo(model: any, options?: any): any; // Add association method
};
...
const Teacher = sequelize.define('Teacher', {
    ...
    hasMany(model: any, options?: any): any; // Add association method
};

// --- Define Associations ---
// A Teacher can have many Students
// Sequelize will look for the 'assignedTeacherId' foreign key in the Student model
Teacher.hasMany(Student, {
        foreignKey: 'assignedTeacherId', // Specifies the foreign key field in the Student model
});
